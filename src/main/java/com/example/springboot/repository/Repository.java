...
public abstract class Repository<T, I> {
    ...
    abstract protected void fillUpdateValues(PreparedStatement st, T data) throws SQLException;
    ...
    abstract protected void fillDeleteValues(PreparedStatement st, T obj) throws SQLException;
